...
- **Native Messaging message size limits** — 1MB in both directions (Chromium source: `kMaximumNativeMessageSize = 1024 * 1024`). Large snapshots may need chunking if they exceed this limit.
